    ...
    public class DrawMinister//:DrawKing
    {
            ...
            )
        {
            ...
            for (int i = 0; i < AllDraw.MinisterMovments; i++)
            {
                ...
                AA.MinisterThinking[i] = new ThinkingChess(i, 5, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)Row, (int)Column);
