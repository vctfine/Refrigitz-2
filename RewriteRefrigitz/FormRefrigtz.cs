    ...
    public partial class FormRefrigtz : Form
    {
      ...
      */
                ...
                /* if (((StateCP) || Person || Blitz) && (!StateCC))
                 {
                     ...
                     try
                     {
                         ...
                         if ((RowRealesed >= 0) && (RowRealesed < 8) && (ColumnRealeased >= 0) && (ColumnRealeased < 8) && ((int)(this.pictureBoxRewriteRefrigitz.Width / 8) >= 0) && ((int)(this.pictureBoxRewriteRefrigitz.Width / 8) < 8) && ((int)(this.pictureBoxRewriteRefrigitz.Height / 8) >= 0) && ((int)(this.pictureBoxRewriteRefrigitz.Height / 8) < 8))
                         {
                             if ((RowRealesed + ColumnRealeased) % 2 == 0)
                                 g.DrawImage(Image.FromFile(Root + "\\Images\\Program\\Black.jpg"), new Rectangle((int)RowRealesed, (int)ColumnRealeased, (int)(this.pictureBoxRewriteRefrigitz.Width / 8), (int)(this.pictureBoxRewriteRefrigitz.Height / 8)));
                             else
                                 g.DrawImage(Image.FromFile(Root + "\\Images\\Program\\White.jpg"), new Rectangle((int)RowRealesed, (int)ColumnRealeased, (int)(this.pictureBoxRewriteRefrigitz.Width / 8), (int)(this.pictureBoxRewriteRefrigitz.Height / 8)));
                         }
        ...
        public FormRefrigtz(bool AllDra)
        {
            ...
            if (!AllDrawLoad)
            {
                this.pictureBoxRewriteRefrigitz.Size = new Size((this.pictureBoxRewriteRefrigitz.Width / 8) * 8, (this.pictureBoxRewriteRefrigitz.Height / 8) * 8);
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (!LoadAG)
            {
                ...
                a.AddRange(Process.GetProcessesByName("RewriteRefrigitz"));
                if (a.Count > 1)
                {
                ...
                lock (O1)
                {
                    if (Draw.SolderesOnTable[i] != null)
                    {
                        try
                        {
                            ...
                            lock (O)
                            {
                                Draw.SolderesOnTable[i].DrawSoldierOnTable(ref g, pictureBoxRewriteRefrigitz.Image.Width / 8, pictureBoxRewriteRefrigitz.Image.Height / 8);
                            }
                        }
                        catch (Exception t)
                        {
                ...
                lock (O1)
                {
                    if (Draw.ElephantOnTable[i] != null)
                    {
                        try
                        {
                            ...
                            lock (O)
                            {
                                Draw.ElephantOnTable[i].DrawElefantOnTable(ref g, pictureBoxRewriteRefrigitz.Image.Width / 8, pictureBoxRewriteRefrigitz.Image.Height / 8);
                            }
                        }
                        catch (Exception t)
                        {
                ...
                lock (O1)
                {
                    if (Draw.HoursesOnTable[i] != null)
                    {
                        try
                        {
                            ...
                            lock (O)
                            {
                                Draw.HoursesOnTable[i].DrawHourseOnTable(ref g, pictureBoxRewriteRefrigitz.Image.Width / 8, pictureBoxRewriteRefrigitz.Image.Height / 8);
                            }
                        }
                        catch (Exception t)
                        {
                ...
                lock (O1)
                {
                    if (Draw.CastlesOnTable[i] != null)
                    {
                        try
                        {
                            ...
                            lock (O)
                            {
                                Draw.CastlesOnTable[i].DrawCastleOnTable(ref g, pictureBoxRewriteRefrigitz.Image.Width / 8, pictureBoxRewriteRefrigitz.Image.Height / 8);
                            }
                        }
                        catch (Exception t)
                        {
                ...
                lock (O1)
                {
                    if (Draw.MinisterOnTable[i] != null)
                    {
                        try
                        {
                            ...
                            lock (O)
                            {
                                Draw.MinisterOnTable[i].DrawMinisterOnTable(ref g, pictureBoxRewriteRefrigitz.Image.Width / 8, pictureBoxRewriteRefrigitz.Image.Height / 8);
                            }
                ...
                lock (O1)
                {
                    if (Draw.KingOnTable[i] != null)
                    {
                        try
                        {
                            ...
                            lock (O)
                            {
                                Draw.KingOnTable[i].DrawKingOnTable(ref g, pictureBoxRewriteRefrigitz.Image.Width / 8, pictureBoxRewriteRefrigitz.Image.Height / 8);
                            }
                        }
                        catch (Exception t)
                        {
        ...
        private void pictureBoxRewriteRefrigitz_Paint(object sender, PaintEventArgs e)
        {
            Object o = new Object();
            lock (o)
            {
                ...
                if (RefrigtzDLL.AllDraw.DrawTable)
                {
                    ...
                    try
                    {
                        ...
                        g.FillRectangle(new SolidBrush(Color.Yellow), new Rectangle(0, 0, pictureBoxRewriteRefrigitz.Width, pictureBoxRewriteRefrigitz.Height));
                        Draw.SetObjectNumbers(Draw.TableList[0]);

                        for (int i = 0; i < pictureBoxRewriteRefrigitz.Image.Width; i += pictureBoxRewriteRefrigitz.Image.Width / 8)
                            for (int j = 0; j < pictureBoxRewriteRefrigitz.Image.Height; j += pictureBoxRewriteRefrigitz.Image.Height / 8)
                            {
                                try
                                {
                                    if ((i + j) % 2 == 0)
                                        g.DrawImage(Image.FromFile(Root + "\\Images\\Program\\Black.jpg"), new Rectangle(i, j, this.pictureBoxRewriteRefrigitz.Width / 8, this.pictureBoxRewriteRefrigitz.Height / 8));
                                    else
                                        g.DrawImage(Image.FromFile(Root + "\\Images\\Program\\White.jpg"), new Rectangle(i, j, this.pictureBoxRewriteRefrigitz.Width / 8, this.pictureBoxRewriteRefrigitz.Height / 8));
                            ...
                            for (int i = 0; i < pictureBoxRewriteRefrigitz.Image.Width; i += pictureBoxRewriteRefrigitz.Image.Width / 8)
                                for (int j = 0; j < pictureBoxRewriteRefrigitz.Image.Height; j += pictureBoxRewriteRefrigitz.Image.Height / 8)
                                {
                                    try
                                    {
                                        if (Tab != null)
                                        {
                                            if (Tab[i / (pictureBoxRewriteRefrigitz.Image.Width / 8), j / (pictureBoxRewriteRefrigitz.Image.Height / 8)])
                                            {
                                                g.DrawString("*", new Font("Times New Roman", 50), new SolidBrush(Color.Red), new Rectangle(i, j, this.pictureBoxRewriteRefrigitz.Width / 8, this.pictureBoxRewriteRefrigitz.Height / 8));
                                            }
                                        }
                                ...
                                if (ColumnClickP == ColumnRealeased && System.Math.Abs(RowClickP - RowRealesed) >= 2 && Table[(int)RowClickP, (int)ColumnClickP] == 6 && (RefrigtzDLL.ChessRules.CastlingAllowedGray))
                                {
                                        ...
                                        if (RefrigtzDLL.AllDraw.MouseClick == 2)
                                    {
                                        if ((new RefrigtzDLL.ChessRules(0, MovementsAStarGreedyHuristicFound, IInoreSelfObjects, UsePenaltyRegardMechnisam, BestMovments, PredictHuristic, OnlySelf, AStarGreedyHuristic, ArrangmentsChanged, 7, Table, 1, (int)RowClickP, (int)ColumnClickP)).Rules((int)RowClickP, (int)ColumnClickP, (int)RowRealesed, (int)ColumnRealeased, Color.Gray, 7))
                                        {
                                            ...
                                            Draw.KingOnTable[King].DrawKingOnTable(ref g, pictureBoxRewriteRefrigitz.Image.Width / 8, pictureBoxRewriteRefrigitz.Image.Height / 8);
                                            Draw.CastlesOnTable[Castles].DrawCastleOnTable(ref g, pictureBoxRewriteRefrigitz.Image.Width / 8, pictureBoxRewriteRefrigitz.Image.Height / 8);
        ...
        private void pictureBoxRewriteRefrigitz_MouseClick(object sender, MouseEventArgs e)
        {
            System.Threading.Thread.Sleep(10);
            MouseClicked = true;
            for (int i = 0; i < 8; i++)
        ...
        private void pictureBoxRewriteRefrigitz_MouseMove(object sender, MouseEventArgs e)
        {
            DrawImageOfMain();
                    ...
                    for (int j = 0; j < 8; j++)
                    {
                        if ((e != null) && (pictureBoxRewriteRefrigitz != null) && (pictureBoxRewriteRefrigitz.Image != null) && (System.Math.Abs(e.X - i * (pictureBoxRewriteRefrigitz.Image.Width / 8)) < pictureBoxRewriteRefrigitz.Image.Width / 8) && (System.Math.Abs(e.Y - j * (pictureBoxRewriteRefrigitz.Image.Height / 8)) < pictureBoxRewriteRefrigitz.Image.Height / 8))
                        {
                            if (RefrigtzDLL.AllDraw.MouseClick == 1)
                            {
                                ...
                                for (int ii = 0; ii < pictureBoxRewriteRefrigitz.Image.Width; ii += pictureBoxRewriteRefrigitz.Image.Width / 8)
                                    for (int jj = 0; jj < pictureBoxRewriteRefrigitz.Image.Height; jj += pictureBoxRewriteRefrigitz.Image.Height / 8)
                                    {
                                        try
                                        {
                                            if ((i >= 0) && (i < 8) && (j >= 0) && (j < 8) && ((int)(this.pictureBoxRewriteRefrigitz.Width / 8) >= 0) && ((int)(this.pictureBoxRewriteRefrigitz.Width / 8) < 8) && ((int)(this.pictureBoxRewriteRefrigitz.Height / 8) >= 0) && ((int)(this.pictureBoxRewriteRefrigitz.Height / 8) < 8)
                                                )
                                            {
                                                if ((ii + jj) % 2 == 0)
                                                    g.DrawImage(Image.FromFile(Root + "\\Images\\Program\\Black.jpg"), new Rectangle((int)ii, (int)jj, (int)(this.pictureBoxRewriteRefrigitz.Width / 8), (int)(this.pictureBoxRewriteRefrigitz.Height / 8)));
                                                else
                                                    g.DrawImage(Image.FromFile(Root + "\\Images\\Program\\White.jpg"), new Rectangle((int)ii, (int)jj, (int)(this.pictureBoxRewriteRefrigitz.Width / 8), (int)(this.pictureBoxRewriteRefrigitz.Height / 8)));
                                            }
                                        ...
                                        if (Tab != null)
                                        {
                                            if (Tab[ii / (int)(pictureBoxRewriteRefrigitz.Image.Width / 8), jj / (int)(pictureBoxRewriteRefrigitz.Image.Height / 8)])
                                            {
                                                if (((int)(this.pictureBoxRewriteRefrigitz.Width / 8) >= 0) && ((int)(this.pictureBoxRewriteRefrigitz.Width / 8) < 8) && ((int)(this.pictureBoxRewriteRefrigitz.Height / 8) >= 0) && ((int)(this.pictureBoxRewriteRefrigitz.Height / 8) < 8 && ((int)(this.pictureBoxRewriteRefrigitz.Height) >= jj) && ((int)(this.pictureBoxRewriteRefrigitz.Width) >= ii)))
                                                {
                                                    g.DrawString("*", new Font("Times New Roman", 50), new SolidBrush(Color.Red), new Rectangle(new Point(ii, jj), new Size((int)(this.pictureBoxRewriteRefrigitz.Width / 8), (int)(this.pictureBoxRewriteRefrigitz.Height / 8))));
                                                }
                                            }
                                        }
                                    }
        ...
        private void pictureBoxRewriteRefrigitz_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            Thread.Sleep(10);
            if (!Maximize)
            {
                RowP = pictureBoxRewriteRefrigitz.Width;
                ColP = pictureBoxRewriteRefrigitz.Height;
                RowSource = this.Width;
                ColumnSource = this.Height;
                this.MaximumSize = new Size(1000, 700);
                pictureBoxRewriteRefrigitz.MaximumSize = new Size(900, 600);
            ...
            else
            {
                ...
                pictureBoxRewriteRefrigitz.MaximumSize = new Size(RowP, ColP);
        ...
        private void pictureBoxRewriteRefrigitz_MouseLeave(object sender, EventArgs e)
        {
            MouseClicked = false;
        }
        ...
        private void pictureBoxRewriteRefrigitz_Click(object sender, EventArgs e)
        {
