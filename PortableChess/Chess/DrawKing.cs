    ...
    public class DrawKing
    {
            ...
            )
        {
            ...
            for (int i = 0; i < AllDraw.KingMovments; i++)
            {
                ...
                AA.KingThinking[i] = new ThinkingRefrigtzChessPortable(i, 6, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)Row, (int)Column);
