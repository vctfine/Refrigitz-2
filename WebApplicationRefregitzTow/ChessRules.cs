...
#pragma warning restore CS0168 // The variable 't' is declared but never used
        ...
        //Initiate of Rules of RefrigtzW Refregitz.
            ...
            lock (O)
            {
                ...
                {             //Gray Order.
                    if (Order == 1)
                    {
                        ...
                        if (RefrigtzW.ChessRules.CastlingAllowedGray)
                        {
                    ...
                    else//Order of Brown.
                    {
                        ...
                        if (RefrigtzW.ChessRules.CastlingAllowedBrown)
                        {
                            //Column Situation.
        ...
        public bool ObjectDangourKingMove(int Order, int[,] Table, bool DoIgnore)
        {
            ...
            {     //long Time = TimeElapced.TimeNow();Spaces++;
                ...
                int CDummy = RefrigtzW.ChessRules.CurrentOrder;
                int COrder = Order;
                if (Order == 1)
                {
                            ...
                            for (int jj = 0; jj < 8; jj++)
                            {
                                ...
                                for (int iii = 0; iii < 8; iii++)
                                {
                                    for (int jjj = 0; jjj < 8; jjj++)
                                    {
                                        ...
                                        RefrigtzW.ThinkingRefrigtzW AA = new RefrigtzW.ThinkingRefrigtzW(-1, 0, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, ii, jj);
            ...
            )
        {
            ...
            lock (OOO)
            {
                ...
                if (A.CheckGray)
                {
                    ...
                    lock (O2)
                    {
                        RefrigtzW.ChessRules.CastlingAllowedGray = false;
                        RefrigtzW.ChessRules.CastleActGray = true;
                        RefrigtzW.ThinkingRefrigtzW.KingMaovableGray = true;
                    }
                }
                else if (A.CheckBrown)
                {
                    ...
                    lock (O2)
                    {
                        ...
                        RefrigtzW.ChessRules.CastlingAllowedBrown = false;
                        RefrigtzW.ThinkingRefrigtzW.KingMaovableBrown = true;
                    }
                }
                bool Castles = false;
                if (Order == 1)
                {
                    if (RefrigtzW.ChessRules.SmallKingCastleGray || RefrigtzW.ChessRules.BigKingCastleGray)
                    {
                        Castles = true;
                    }
                }
                ...
                if (Order == -1)
                {
                    if (RefrigtzW.ChessRules.SmallKingCastleBrown || RefrigtzW.ChessRules.BigKingCastleBrown)
                    {
                        Castles = true;
                    }
                }
                ...
                if (SodierConvert || (Castling && Castles))
                {
                    ...
                    if (Castling)
                    {
                        ...
                        if (RefrigtzW.ChessRules.SmallKingCastleGray)
                        {
                            ...
                            if (RefrigtzW.ChessRules.BigKingCastleGray)
                        //Castles Brown King.                    
                        {
                            object O2 = new object();
                            lock (O2)
                            {
                                ...
                                if (RefrigtzW.ChessRules.SmallKingCastleBrown)
                        //Castles Brown King.                    
                        {
                            object O2 = new object();
                            lock (O2)
                            {
                                ...
                                lock (O)
                                {
                                    ...
                                    if (RefrigtzW.ChessRules.BigKingCastleBrown)
                        //Castles Brown King.                    
                        {
                            ...
                            else//else of Condition.
                            {
                                ...
                                for (int ii = 0; ii < 8; ii++)
                                {
                                    for (int jj = 0; jj < 8; jj++)
                                    {
                                        ...
                                        if ((new RefrigtzW.ThinkingRefrigtzW(-1, 0, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, i, j)).Movable(CloneATable(Table), i, j, ii, jj, A, Order))
                                        {
                                ...
                                for (int jj = 0; jj < 8; jj++)
                                {
                                    ...
                                    if (Table[i, j] < 0)
                                    {
                                        ...
                                        if (Table[ii, jj] > 0)
                                        {
                                            ...
                                            //If Is Movable.
                                            if ((new RefrigtzW.ThinkingRefrigtzW(-1, 0, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, i, j)).Movable(CloneATable(Tab), i, j, ii, jj, Color.Brown, -1))
                                            {
                                                //Clone a Copy.
                                                for (int iii = 0; iii < 8; iii++)
                                                {
                                ...
                                for (int jj = 0; jj < 8; jj++)
                                {
                                    ...
                                    if (Table[i, j] > 0)
                                    {
                                        ...
                                        if (Table[ii, jj] < 0)
                                        {
                                            ...
                                            if ((new RefrigtzW.ThinkingRefrigtzW(-1, 0, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, i, j)).Movable(CloneATable(Tab), i, j, ii, jj, Color.Gray, 1))
                                            {
                                                for (int iii = 0; iii < 8; iii++)
                                                {
                                                    for (int jjj = 0; jjj < 8; jjj++)
            ...
            {   //long Time = TimeElapced.TimeNow();Spaces++;
                ...
                for (int i = 0; i < 8; i++)
                {
                    for (int j = 0; j < 8; j++)
                    {
                        ...
                        if ((new RefrigtzW.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Table[ii, jj], CloneATable(Table), Order, ii, jj)).Rules(ii, jj, i, j, a, Table[ii, jj]))
                        {
                            Tab[i, j] = true;
                        }
                        if ((new RefrigtzW.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Table[ii, jj], CloneATable(Table), Order, ii, jj)).Rules(ii, jj, i, j, a, Table[ii, jj]))
            ...
            {    //long Time = TimeElapced.TimeNow();Spaces++;
                ...
                for (int i = 0; i < 8; i++)
                {
                    for (int j = 0; j < 8; j++)
                    {
                        ...
                        RefrigtzW.ChessRules A = new RefrigtzW.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Table[i, j], CloneATable(Table), Ord, i, j);
                        if (Ord == 1)
                        {
                        ...
                        //Initiate Global Variables.
                        RefrigtzW.ChessRules.CurrentOrder = Dummt;
                ...
                for (int i = 0; i < 8; i++)
                {
                    for (int j = 0; j < 8; j++)
                    {
                        ...
                        if (Checked)
                        {
                            ...
                            RefrigtzW.ChessRules A = new RefrigtzW.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Table[RowK, ColumnK], CloneATable(Table), Ord, RowK, ColumnK);
                            Order = DummyOrder;
                            ///Table[ii, jj] = 0;
                            //Menen Parameter is Moveble to Second Parameters Location returm Movable.
                            for (int k = 0; k < 8; k++)
                        ...
                        for (int ii = 0; ii < 8; ii++)
                        {
                            ...
                            for (int jj = 0; jj < 8; jj++)
                            {
                                ...
                                if (A.Rules(i, j, ii, jj, a, Ord))
                                {
                                    ...
                                    Table[i, j] = 0;
                                    //If Check.
                                    A = new RefrigtzW.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Table[ii, jj], CloneATable(Table), Ord, ii, jj);
                                    if (A.Check(CloneATable(Table), Ord))
                                    {
                                        Order = DummyOrder;
                                        //Move Back.
        ...
        public bool CheckMate(int[,] Tab, int Ord)
        {
            ...
            {     //long Time = TimeElapced.TimeNow();Spaces++;
                ...
                RefrigtzW.ChessRules A = new RefrigtzW.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Table[RowG, ColumnG], CloneATable(Table), Ord, RowG, ColumnG);
                ...
                RefrigtzW.ChessRules AA = new RefrigtzW.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Table[RowB, ColumnB], CloneATable(Table), Ord, RowB, ColumnB);
        ...
        //Internal Rule of RefrigtzW Method.
