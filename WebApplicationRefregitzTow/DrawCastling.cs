    ...
    public class DrawCastling
    {
            ...
            )
        {
            ...
            for (int i = 0; i < AllDraw.KingMovments; i++)
            {
                ...
                AA.CastlingThinking[i] = new ThinkingRefrigtzW(i, 6, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)Row, (int)Column);
