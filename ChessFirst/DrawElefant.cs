...
namespace ChessFirst
{
...

    {
        ...
        public ThinkingChessFirst[] ElefantThinking = new ThinkingChessFirst[AllDraw.ElefantMovments];
            ...
            )
        {
            ...
            for (int i = 0; i < AllDraw.ElefantMovments; i++)
            {
                ...
                AA.ElefantThinking[i] = new ThinkingChessFirst(i, 2, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)Row, (int)Column);
