...
namespace ChessFirst
{
    ...
    public class DrawMinister//:DrawKing
    {
        ...
        public int Order;
        public ThinkingChessFirst[] MinisterThinking = new ThinkingChessFirst[AllDraw.MinisterMovments];
            ...
            )
        {
            ...
            for (int i = 0; i < AllDraw.MinisterMovments; i++)
            {
                ...
                AA.MinisterThinking[i] = new ThinkingChessFirst(i, 5, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)Row, (int)Column);
