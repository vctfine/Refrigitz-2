...
namespace ChessFirst
{
    ...
    public class DrawHourse
    {
        ...
        public ThinkingChessFirst[] HourseThinking = new ThinkingChessFirst[AllDraw.HourseMovments];
            ...
            )
        {
            ...
            for (int i = 0; i < AllDraw.HourseMovments; i++)
            {
                ...
                AA.HourseThinking[i] = new ThinkingChessFirst(i, 3, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)Row, (int)Column);
