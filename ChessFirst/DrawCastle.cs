    ...
    public class DrawCastle
    {
            ...
            )
        {
            ...
            for (int i = 0; i < AllDraw.CastleMovments; i++)
            {
                ...
                AA.CastleThinking[i] = new ThinkingChessFirst(i, 4, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)Row, (int)Column);
