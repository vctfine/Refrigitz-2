...
namespace ChessFirst
{
    ...
    public class DrawSoldier : ThingsConverter
    {
        ...
        public Color color;
        public ThinkingChessFirst[] SoldierThinking = new ThinkingChessFirst[AllDraw.SodierMovments];
            ...
            )
        {
            ...
            for (int i = 0; i < AllDraw.SodierMovments; i++)
            {
                ...
                AA.SoldierThinking[i] = new ThinkingChessFirst(i, 1, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)Row, (int)Column);
