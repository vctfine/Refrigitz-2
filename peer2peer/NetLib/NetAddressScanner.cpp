// NetAddressScanner.cpp: implementation of the CNetAddressScanner class.
//
...
CNetAddressScanner::CNetAddressScanner()
{
}
...
CNetAddressScanner::Tokens CNetAddressScanner::GetToken(const char* szInput, string& strToken)
{
  strToken = "";
