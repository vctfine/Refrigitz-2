...
namespace OpenCL
{
    public class EasyCL
    {
        ...
        {
            ComputeMethod method = new ComputeMethod(OpenCLlib.Kernels.PerformanceKernel, "DoublePerformance", Device);
            return GetGFlops(method,false);
        }

        public static double GetDeviceGFlops_Single(AcceleratorDevice Device)
        {
            ComputeMethod method = new ComputeMethod(OpenCLlib.Kernels.PerformanceKernel, "SinglePerformance", Device);
            return GetGFlops(method,true);
        }

        public static double GetDeviceBandwidth_GBps(AcceleratorDevice Device)
        {
            ComputeMethod method = new ComputeMethod(OpenCLlib.Kernels.PerformanceKernel, "Bandwidth", Device);
