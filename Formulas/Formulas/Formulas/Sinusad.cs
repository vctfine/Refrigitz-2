...
namespace Formulas
{
    public partial class Sinusad : Form
    {
        ...
        private Trianglic Tr = null;
        private int INTPressde = -1;
        private static readonly int[] SquredPushed = new int[2];
        private int DummyRow = 0, DummyColumn = 0;
        private readonly PictureBox Sin = new PictureBox();
        private readonly PictureBox Cos = new PictureBox();
        private readonly PictureBox Tan = new PictureBox();
        private readonly PictureBox Cot = new PictureBox();
        private readonly PictureBox Sec = new PictureBox();
        private readonly PictureBox Csc = new PictureBox();
        private readonly Equation EqationVariable = null;
