...
namespace Formulas
{
    ...
    {
        public static bool IsMulInNode(AddToTree.Tree Dummy)
        {
            if (Dummy == null)
            {
                return false;
        ...
        public static bool ReterunIfIsNumberNode(AddToTree.Tree Dummy, ref AddToTree.Tree Number)
        {
            if (Dummy == null)
            {
                return false;
        ...
        public static bool ReterunIfIsPlusNode(AddToTree.Tree Dummy, ref AddToTree.Tree[] Plus, ref int Len)
        {
            if (Dummy == null)
            {
                return false;
        ...
        public static bool IsMulAllNode(AddToTree.Tree Dummy)
        {
            if (Dummy == null)
            {
                return true;
        ...
        public static bool IsPlusOrMulAllNode(AddToTree.Tree Dummy)
        {
            if (Dummy == null)
            {
                return true;
        ...
        public static bool IsZeroNode(AddToTree.Tree Dummy)
        {
            if (Dummy == null)
            {
                return false;
        ...
        public static bool IsPluSinNode(AddToTree.Tree Dummy)
        {
            if (Dummy == null)
            {
                return false;
        ...
        public static bool IsNotUpperPowerOfNodeInList(AddToTree.Tree Dummy, AddToTreeTreeLinkList AbaledFactors, ref float PowerExsistNumber)
        {
            bool Is = false;
        ...
        public static bool ExistElementOnAllMulatedNodes(AddToTree.Tree Dummy, AddToTreeTreeLinkList Consideration, ref UknownIntegralSolver UIS)
        {
            bool Is = true;
        ...
        private static bool ExistElementOnAllMulatedNodesAction(AddToTree.Tree Dummy, AddToTreeTreeLinkList MULATEDELEMENTS)
        {
            bool Is = false;
        ...
        public static bool IsNotMinusAndPluseInNode(AddToTree.Tree Dummy)
        {
            if (Dummy == null)
            {
                return true;
        ...
        public static bool IsDivInNode(AddToTree.Tree Dummy)
        {
            if (Dummy == null)
            {
                return false;
        ...
        public static bool IsMinusAndPluseFirstNode(AddToTree.Tree Dummy)
        {
            bool Is = false;
            if (Dummy.SampleAccess == "+")
            {
        ...
        public static bool IsMinuseOrPluse(string Sample)
        {
        ...
        public static bool IsPluse(string Sample)
        {
            bool IsPluse = false;
            if (Sample != null)
            {
        ...
        public static bool IsMulOrDiv(string Sample)
        {
        ...
        public static bool IsDiv(string Sample)
        {
            bool IsDiv = false;
            if (Sample != null)
            {
        ...
        public static bool IsMul(string Sample)
        {
            bool IsMul = false;
            if (Sample != null)
            {
        ...
        public static bool IsOperator(string Sample)
        {
        ...
        public static bool ISindependenceVaribaleOrNumber(string Sample)
        {
        ...
        public static bool IsFunction(string Sample)
        {
        ...
        public static bool IsNumber(string Sample)
        {
            bool IsNumber = false;
            if (Sample != null)
            {
        ...
        public static bool IsNumberNegative(string Sample)
        {
        ...
        public static bool IsParantez(string Sample)
        {
        ...
        public static bool IsPower(string Sample)
        {
            bool Is = false;
            if (Sample == "^")
            {
        ...
        private static bool IsEqualWithThreadConsiderationCommonlySample(string Sample)
        {
            bool Is = false;
            if (Sample == "=")
            {
        ...
        public static bool ISindependenceVaribale(string Sample)
        {
