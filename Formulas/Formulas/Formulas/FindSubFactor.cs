...
namespace Formulas
{
    internal static class FindSubFactor
    {
        private static readonly AddToTreeTreeLinkList FACTORLISTEDS = new AddToTreeTreeLinkList();
        private static readonly AddToTreeTreeLinkList COMMONFACTORS = new AddToTreeTreeLinkList();
        private static readonly AddToTreeTreeLinkList NOTEXPECTED = new AddToTreeTreeLinkList();
        public static AddToTreeTreeLinkList FindSubFactorFx(AddToTree.Tree Dummy1, AddToTree.Tree Dummy2)
        {
        ...
        public static AddToTreeTreeLinkList NotExpectedAccess()
        {
            return NOTEXPECTED;
        }
        public static AddToTreeTreeLinkList FACTORLISTEDSAccess()
        {
            return FACTORLISTEDS;
        }

        private static void FindSubFactorActionFx(AddToTree.Tree Dummy1, AddToTree.Tree Dummy2)
        {
        ...
        private static void FindSubFactorCommonAddedToListFx(AddToTree.Tree Dummy1)
        {
            if (Dummy1 == null)
            {
                return;
        ...
        private static void FindSubFactorCommonFinalizationFx(AddToTree.Tree Dummy2)
        {
            if (Dummy2 == null)
            {
                return;
