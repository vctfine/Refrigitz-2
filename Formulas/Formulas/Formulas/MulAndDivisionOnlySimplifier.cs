namespace Formulas
{
    internal static class MulAndDivisionOnlySimplifier
    {
        public static AddToTree.Tree MulAndDivisionOnlySimplifierFx(AddToTree.Tree Dummy)
        {
        ...
        private static bool IsCurrentNodeMulOrDivisionOnly(AddToTree.Tree Dummy)
        {
            bool Is = true;
            /*    if (Dummy == null)
                    return Is;
        ...
        private static bool MulAndDivisionOnlySimplifierFindDivisionOperandIfIsDelettingFx(AddToTree.Tree Dummy, AddToTree.Tree NodeDeleted)
        {
            bool Is = false;
            if (Dummy == null)
            {
        ...
        private static AddToTree.Tree MulAndDivisionOnlySimplifierFxAction(AddToTree.Tree Dummy)
        {
            if (Dummy == null)
            {
                return Dummy;
