namespace Formulas
{
    internal static class DeleteingMinusPluseTree
    {

        public static AddToTree.Tree DeleteingMinusPluseFx(AddToTree.Tree Dummy)
        {
        ...
        private static AddToTree.Tree ArrangmentToDeleteingMinusPluse(AddToTree.Tree Dummy)
        {
            if (Dummy == null)
            {
                return Dummy;
        ...
        private static AddToTree.Tree RepeatedlyDeletedAction(AddToTree.Tree Dummy)
        {
            if (Dummy == null)
            {
                return Dummy;
